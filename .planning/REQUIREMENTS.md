...
- [x] **SRCH-04**: User can save a named search query and retrieve it in future sessions
- [x] **SRCH-05**: User can display a saved search as a smart folder in the folder tree
...
| SRCH-04 | Phase 33 | Complete |
| SRCH-05 | Phase 33 | Complete |
