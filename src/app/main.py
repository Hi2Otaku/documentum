...
from app.routers import aliases, audit, auth, dashboard, document_types, documents, events, folders, groups, health, inbox, lifecycle, notifications, query, queues, relationships, renditions, retention, roles, signatures, templates, users, virtual_documents, workflows
